...
ax[0].axvspan(37+0.1, len(df_term)-0.1, ymin=0, ymax=1, alpha=0.2, color='grey', label='Unobserved period')
...
fig.suptitle("Predicted Chikungunya importations to Europe", y=0.95, size=18)
plt.tight_layout()
...
for i in range(len(rph)):
    ...
    ax.grid(alpha=0.5)
ax.set_title("Chikungunya 2012-2025", pad=20, size=30)
