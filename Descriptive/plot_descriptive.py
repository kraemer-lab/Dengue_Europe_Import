...
im0 = ax[0,0].imshow(np.arange(4, 0, -1).reshape(2, 2)/4, cmap='cool', origin="lower", vmin=0, vmax=vmax_tot)
...
out_eu_den_tot.plot(column='travellers_ee', cmap="cool", ax=ax[0,0], vmin=0, vmax=vmax_tot)
ax[0,0].axis("off")
ax[0,0].set_title("Average Total Travellers (approx.)", size=16)
plt.text(0, 1, "A", size=16, transform=ax[0,0].transAxes)
im1 = ax[0,1].imshow(np.arange(4, 0, -1).reshape(2, 2)/4, cmap='plasma', origin="lower", vmin=0, vmax=vmax_den)
...
out_eu_den_imp.plot(column='imported', cmap="plasma", ax=ax[0,1])
ax[0,1].axis("off")
ax[0,1].set_title("Average Dengue Importations", size=16)
plt.text(0, 1, "B", size=16, transform=ax[0,1].transAxes)
im2 = ax[1,0].imshow(np.arange(4, 0, -1).reshape(2, 2)/4, cmap='plasma', origin="lower", vmin=0, vmax=vmax_chik)
...
out_eu_chik_imp.plot(column='imported', cmap="plasma", ax=ax[1,0], vmin=0, vmax=vmax_chik)
ax[1,0].axis("off")
ax[1,0].set_title("Average Chikungunya Importations", size=16)
plt.text(0, 1, "C", size=16, transform=ax[1,0].transAxes)
im3 = ax[1,1].imshow(np.arange(4, 0, -1).reshape(2, 2)/4, cmap='plasma', origin="lower", vmin=0, vmax=vmax_zika)
...
out_eu_zika_imp.plot(column='imported', cmap="plasma", ax=ax[1,1])
ax[1,1].axis("off")
